    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 py-16">
        <div className="max-w-2xl">
          <div className="w-24 h-24 bg-primary-600 rounded-3xl mx-auto mb-8 flex items-center justify-center shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/login"
              className="bg-primary-600 hover:bg-primary-700 text-white font-semibold px-8 py-3 rounded-xl transition-colors text-lg shadow-md"
            >
              Přihlásit se
            </Link>
          </div>
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl w-full">
          {[
            ...
            <div key={f.title} className="bg-white/70 backdrop-blur rounded-xl p-6 shadow-sm">
