...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Harmonogram", href: "/reception/schedule", icon: <Calendar size={18} />, roles: ["RECEPTION"] },
  ...
  { label: "Pojišťovny", href: "/admin/insurance", icon: <FileText size={18} />, roles: ["ADMIN"] },
  { label: "Poj. fakturace", href: "/admin/insurance/billing", icon: <CreditCard size={18} />, roles: ["ADMIN"] },
